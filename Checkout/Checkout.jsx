    ...
    <>
      <div>
        ...
        <Typography variant="subtitle2">Order ref: {order.customer_reference}</Typography>
			<Typography variant='subtitle4'>Look in your email for more order information</Typography>
      </div>
      <br />
      <Button component={Link} variant="outlined" type="button" to="/products">Back to Shop</Button>
    </>
  ) : isFinished ? (
		 <>
      <div>
    ...
    <>
      ...
      <main className={classes.layout}>
        <Paper className={classes.paper}>
          <Typography className="Check" variant="h4" align="center">C h e c k o u t</Typography>
